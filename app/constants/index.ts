...
export const BACHELOR_MANDATORY_ELECTIVE_CAP = 60;

export const bachelorAreaMaxCredits: Record<keyof typeof areaNames, number> = {
  foundation: 4,
  cs: 9,
  math: 9,
  ai: 48,
...
export const courses: Course[] = [
  {
    id: "cog",
    name: "Foundation of Cognitive Science",
    credits: 3,
    category: "foundation",
    required: true,
  },
  {
    id: "stats",
    name: "Intro to Statistics and Data Analysis",
    credits: 8,
    category: "foundation",
    required: true,
  },
  ...
  {
    id: "phil",
    name: "Introduction to Philosophy for CogSci",
    credits: 4,
    category: "philosophy",
    required: true,
  },
  {
    id: "ethics",
    name: "Introduction to the Ethics of AI",
    credits: 4,
    category: "philosophy",
    required: true,
  },
